...
namespace FiddlerControls
{
    public partial class Sounds : UserControl
    {
        ...
        private void OnLoad(object sender, EventArgs e)
        {
            ...
            {
                if (Ultima.Sounds.IsValidSound(i, out name))
                {
        ...
        private void PlaySound(object sender, EventArgs e)
        {
            ...
            if (treeView.SelectedNode == null)
                return;
            Ultima.UOSound s = Ultima.Sounds.GetSound((int)treeView.SelectedNode.Tag);
        ...
        private void OnDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            if (treeView.SelectedNode == null)
                return;
            Ultima.UOSound s = Ultima.Sounds.GetSound((int)e.Node.Tag);
            using (MemoryStream m = new MemoryStream(s.buffer))
            {
                sp.Stream = m;
                sp.Play();
        ...
        private void afterSelect(object sender, TreeViewEventArgs e)
        {
            if (treeView.SelectedNode == null)
                return;
            seconds.Text = String.Format("{0:f}s", Ultima.Sounds.GetSoundLength((int)treeView.SelectedNode.Tag));
        }
