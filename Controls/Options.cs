...
namespace FiddlerControls
{
    public sealed class Options
    {
        ...
        static Options()
        {
        	AppDataPath = Path.GetDirectoryName(Assembly.GetEntryAssembly().Location);
            //AppDataPath = Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "UoFiddler");
        }
    }
}
